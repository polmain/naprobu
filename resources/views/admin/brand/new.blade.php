...
@section('content')
    <div class='row'>
        <form action="{{route('adm_brand_create')}}" method="post" enctype="multipart/form-data" class="validation-form">
            {{ csrf_field() }}
            <div class='col-md-9'>
                <!-- Box -->
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="text_1-1">
                                        <textarea class="editor" name="review" rows="10" cols="80"></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
