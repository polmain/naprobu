...
@section('content')
    <div class='row'>
        <form action="{{route('admin.country.save',['country_id'=>$country->id])}}" method="post" enctype="multipart/form-data" class="validation-form">
            {{ csrf_field() }}
            <div class='col-md-9'>
                <!-- Box -->
                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="name-ru" name="name" class="form-control required" placeholder="Введите название страны..." value="{{$country->name}}">
                            </div>
                            <div class="col-md-4">
                                <label><img src="{{asset('/public/images/ukraine.png')}}" alt="Флаг Украины"> Название страны<span class="input-request">*</span></label>
                                <input type="text" id="name-ua" name="nameUA" class="form-control required" placeholder="Введите название страны..." value="{{$country->translate->firstWhere('lang', 'ua')? $country->translate->firstWhere('lang', 'ua')->name : ''}}">
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" id="name-en" name="nameEN" class="form-control required" placeholder="Введите название страны..." value="{{$country->translate->firstWhere('lang', 'en')? $country->translate->firstWhere('lang', 'en')->name : ''}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label>Код страны<span class="input-request">*</span></label>
                                <input type="text" id="code" name="code" class="form-control required" placeholder="Введите код страны..." value="{{$country->code}}">
                            </div>
                        </div>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
