...
@section('content')
    <div class='row'>
        <form action="{{route('admin.region.save',['region_id'=>$region->id])}}" method="post" enctype="multipart/form-data" class="validation-form">
            {{ csrf_field() }}
            <div class='col-md-9'>
                <!-- Box -->
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control select2 required" name="country_id" id="country_id">
                                    <option value="{{$region->country->id}}" selected="selected">{{$region->country->name}}</option>
                                </select>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
