            ...
            <div class='col-md-9'>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Основные параметры Области</h3>
                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="name-ru" name="name" class="form-control required" placeholder="Введите название области...">
                            </div>
                            <div class="col-md-4">
                                <label><img src="{{asset('/public/images/ukraine.png')}}" alt="Флаг Украины"> Название страны<span class="input-request">*</span></label>
                                <input type="text" id="name-ua" name="nameUA" class="form-control required" placeholder="Введите название области...">
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" id="name-en" name="nameEN" class="form-control required" placeholder="Введите название области...">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <button type="button" class="btn btn-block btn-danger btn-lg" onclick="document.location.href='/admin/regions/';">Отмена</button>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                <!-- Box -->
