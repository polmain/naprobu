                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="name-ua" name="nameUA" class="form-control project-name required" value="{{$translate->name}}" placeholder="Введите название категории...">
                            </div>
                        </div>
                        ...
                        <div class="form-group project-url edit" id="project-url-ua"><img src="{{asset('/public/images/ukraine.png')}}" alt="Флаг Украины"> Постоянная ссылка: <div class="edit-url">
                                <div class="edit-a active">
                                    <a href="{{(Request::secure())?"https://":"http://"}}{{Request::getHost()}}/project/" class="link-url"><span class="static-part">{{(Request::secure())?"https://":"http://"}}{{Request::getHost()}}/project/</span><span class="edit-part">{{$translate->url}}</span></a>
                                    <button type="button" class="btn btn-default btn-sm change-url">Изменить</button>
                                </div>
                                <div class="edit-input">
                                    {{(Request::secure())?"https://":"http://"}}{{Request::getHost()}}/project/<input type="text" class="new-url" name="urlUA" value="{{$translate->url}}">
                                    <button type="button" class="btn btn-success btn-sm save-url">Ок</button>
                                    <button type="button" class="btn btn-default btn-sm cancel-url">Отмена</button>
                                </div>
                            </div>
                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="titleUA" name="titleUA" class="form-control" value="{{$translate->seo_title}}" placeholder="Введите Title категории...">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="descriptionUA" rows="5" placeholder="Введите Description категории...">{{$translate->seo_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="keywordsUA" value="{{$translate->seo_keyword}}"  placeholder="Введите Keywords категории...">
                            </div>
                        </div>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
