...
@section('content')
    <div class='row'>
        <form action="{{route('adm_project_links_create')}}" method="post" enctype="multipart/form-data" class="validation-form">
            {{ csrf_field() }}
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <button type="button" class="btn btn-block btn-danger btn-lg" onclick="document.location.href='/admin/project/{{$project->id}}/links/';">Отмена</button>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                <!-- Box -->
                <!-- Box -->
