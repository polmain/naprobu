...
@section('content')
    <div class='row'>
        <form action="{{route('adm_project_message_create')}}" method="post" enctype="multipart/form-data" class="validation-form">
            {{ csrf_field() }}
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="text_1-1">
                                        <textarea class="form-control required" id="text" name="text" rows="10" cols="80"></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <button type="button" class="btn btn-block btn-danger btn-lg" onclick="document.location.href='/admin/project/{{$project->id}}/messages/';">Отмена</button>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                <!-- Box -->
                <!-- Box -->
