                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="name-ua" name="nameUA" class="form-control project-name" placeholder="Введите название проекта...">
                            </div>
                            <div class="col-md-4">
                                <label><img src="{{asset('/public/images/united-kingdom.png')}}" alt="Флаг Великой бриатнии"> Название проекта</label>
                                <input type="text" id="name-en" name="nameEN" class="form-control project-name" placeholder="Введите название проекта...">
                            </div>
                        </div>
                        ...
                        <div class="form-group project-url edit url-en" id="project-url-en"><img src="{{asset('/public/images/united-kingdom.png')}}" alt="Флаг Великой бриатнии"> Постоянная ссылка: <div class="edit-url">
                                <div class="edit-a active">
                                    <a href="{{(Request::secure())?"https://":"http://"}}{{Request::getHost()}}/en/projects/" class="link-url"><span class="static-part">{{(Request::secure())?"https://":"http://"}}{{Request::getHost()}}/en/projects/</span><span class="edit-part"></span></a>
                                    <button type="button" class="btn btn-default btn-sm change-url">Изменить</button>
                                </div>
                                <div class="edit-input">
                                    {{(Request::secure())?"https://":"http://"}}{{Request::getHost()}}/en/projects/<input type="text" class="new-url" name="urlEN">
                                    <button type="button" class="btn btn-success btn-sm save-url">Ок</button>
                                    <button type="button" class="btn btn-default btn-sm cancel-url">Отмена</button>
                                </div>
                            </div>
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_2-2">
                                        <textarea class="form-control" name="short_descriptionUA" rows="5" placeholder="Введите краткое описание проекта..."></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="tab_2-3">
                                        <textarea class="form-control" name="short_descriptionEN" rows="5" placeholder="Введите краткое описание проекта..."></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                </div>
                                <!-- /.tab-content -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="product_nameUA" name="product_nameUA" class="form-control" placeholder="Введите краткое название продукта...">
                            </div>
                            <div class="col-md-4">
                                <label><img src="{{asset('/public/images/united-kingdom.png')}}" alt="Флаг Великой бриатнии"> Краткое название продукта</label>
                                <input type="text" id="product_nameEN" name="product_nameEN" class="form-control" placeholder="Введите краткое название продукта...">
                            </div>
                        </div>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="text_5-3">
                                <textarea class="editor" id="text" name="product_infoEN" rows="10" cols="80"></textarea>
                            </div>
                            <!-- /.tab-pane -->
                        </div>
                        <!-- /.tab-content -->
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="text_6-3">
                                <textarea class="editor" id="text" name="faqEN" rows="10" cols="80"></textarea>
                            </div>
                            <!-- /.tab-pane -->
                        </div>
                        <!-- /.tab-content -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="seo_description_en" rows="5" placeholder="Введите Description проекта..."></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control required" id="sub-url" name="category" style="width: 100%;">
                                ...
                                @foreach($categories as $category)
                                    <option
                                        data-url-ru="{{$category->url}}"
                                        data-url-ua="{{$category->translate->firstWhere('lang', 'ua')? $category->translate->firstWhere('lang', 'ua')->url : ''}}"
                                        data-url-en="{{$category->translate->firstWhere('lang', 'en')? $category->translate->firstWhere('lang', 'en')->url : ''}}"
                                        value="{{$category->id}}">
                                        {{$category->name}}
                                    </option>
                                @endforeach
