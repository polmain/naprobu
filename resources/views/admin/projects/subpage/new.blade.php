                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="name-ua" name="nameUA" class="form-control project-name required" placeholder="Введите название подстраницы...">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control required select2" id="sub-url" name="project" style="width: 100%;">
                                ...
                                @foreach($projects->reverse() as $project)
                                    <option data-url-ru="{{$project->category->url}}/{{$project->url}}" data-url-ua="{{$project->category->translate->url}}/{{(!empty($project->translate))?$project->translate->url:''}}" value="{{$project->id}}">{{$project->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
