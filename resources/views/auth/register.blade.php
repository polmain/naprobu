                                ...
                                <div class="form-group">
                                    ...
                                    <select name="education" id="education" class="form-control">
                                        @foreach($educationArray as $education)
                                            <option value="{{$education}}">{{"registration.education_".$education}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="employment" id="employment" class="form-control">
                                        @foreach($employmentArray as $employment)
                                            <option value="{{$employment}}">{{"registration.employment_".$employment}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="work" id="work" class="form-control">
                                        @foreach($workArray as $work)
                                            <option value="{{$work}}">{{"registration.work_".$work}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="family_status" id="family_status" class="form-control">
                                        @foreach($familyStatusArray as $familyStatus)
                                            <option value="{{$familyStatus}}">{{"registration.family_status_".$familyStatus}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="material_condition" id="material_condition" class="form-control">
                                        @foreach($materialConditionArray as $materialCondition)
                                            <option value="{{$materialCondition}}">{{"registration.material_condition_".$materialCondition}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label class="form-check">{{"registration.hobbies_".$materialCondition}}
