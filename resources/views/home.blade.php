...
<div class="home-page">
    <section class="banner">
        <div class="container">
            <h1><strong class="orange-text">{{trans('independent_testing')}}</strong><br>
                {{trans('famous_brands')}}</h1>
            @auth
                            ...
                            <div class="row">
                                <div class="expert-step col-sm-4">
                                    <div class="image-container">
                                        ...
                                        <img src="{{asset('public/svg/main/step_1.svg')}}" alt="{{trans('sign_up_mainpage')}}">
                                    </div>
                                    <p>{{trans('sign_up_mainpage')}}</p>
                                </div>
                                <div class="expert-step col-sm-4">
                                    <div class="image-container image-container-bottom">
                                        <div class="img-circle"></div>
                                        <img src="{{asset('public/svg/main/step_2.svg')}}" alt="{{trans('test_mainpage')}}">
                                    </div>
                                    <p>{{trans('test_mainpage')}}</p>
                                </div>
                                <div class="expert-step col-sm-4">
                                    <div class="image-container">
                                        <div class="img-circle"></div>
                                        <img src="{{asset('public/svg/main/step_3.svg')}}" alt="{{trans('share_your_opinion_mainpage')}}">
                                    </div>
                                    <p>{{trans('share_your_opinion_mainpage')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="row banner-action">
                        ...
                        <div class="col-lg-3 col-sm-6 col-10 offset-1 offset-sm-3 offset-lg-0 go-to-expert mb-3">
                            <a href="{{route('user.cabinet')}}" class="go-to-expert-link">{{trans('become_expert_mainpage')}}</a>
                        </div>
                    </div>
                @endif
            @else
                <div class="row banner-action">
                    ...
                    <div class="col-lg-3 col-sm-6 col-10 offset-1 offset-sm-3 offset-lg-0 go-to-expert mb-3">
                        <a href="{{route('registration')}}" class="go-to-expert-link">{{trans('become_expert_mainpage')}}</a>
                    </div>
                </div>
            @endauth
        </div>
    ...
    <section class="main-projects">
        <div class="container">
            <h2>{{trans('last_project_mainpage')}}</h2>
    ...
    <section class="who-we">
        <div class="container">
            <h2>{{trans('number_block_title')}}</h2>
            <div class="row ">
    ...
    <section class="main-reviews">
        <div class="container">
            <h2>{{trans('current_reviews_mainpage')}}</h2>
