        ...
        <div class="review-images">
            ...
            @foreach($subpage_base->project->review_images as $image)
                @if(++$i <= $max_image || count($subpage_base->project->review_images) <= $max_image)
                    <a class="review-image" data-fancybox="review_gallery" href="/public/uploads/images/projects/{{$image[1]}}" style="background-image: url('/public/uploads/images/reviews/{{$image[0]}}')"></a>
                @elseif(++$i == 4)
                    <a class="review-image" data-fancybox="review_gallery" href="/public/uploads/images/projects/{{$image[1]}}" style="background-image: url('/public/uploads/images/reviews/{{$image[0]}}')"><div class="more-image">{{count($subpage_base->project->review_images) - 2}}</div></a>
                @else
