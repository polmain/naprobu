        ...
        <div class="review-content">
                ...
                @auth
                    @if($review->user->id == Auth::user()->id)
                        <div class="review-edit">
                            @lang('review.review_edit')
                        </div>
                    @endif
                @endauth
            </div>
            <input type="hidden" class="review-video" value='{{$review->video}}'>
            ...
            @if(isset($review->images) || (isset($review->video)  && $review->video != ""))
                @if(isset($review->images))
                    <input type="hidden" class="review-image-arr" value='{!! json_encode ($review->images) !!}'>
                @endif
                <div class="review-images ml-0">
                    @php
                        $i = 0;
                        $max_image = 3;
                    @endphp
                    ...
                    @foreach($review->images as $image)
                        ...
                        @else
                            <a class="review-image review-image-hidden" data-fancybox="review_{{$review->id}}" href="/public/uploads/images/reviews/{{$image[1]}}" style="background-image: url('/public/uploads/images/reviews/{{$image[0]}}')"></a>
                        @endif
                    @endforeach
                    @endif
                </div>
