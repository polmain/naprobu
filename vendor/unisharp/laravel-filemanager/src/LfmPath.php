...
class LfmPath
{
    ...
    {
        return str_replace('//public','/public',str_replace($this->helper->ds(), Lfm::DS, $path));
    }

    public function translateToOsPath($path)
    {
        return str_replace('//public','/public',str_replace(Lfm::DS, $this->helper->ds(), $path));
    }

    public function url()
    {
        return str_replace('//public','/public',$this->storage->url($this->path('url')));
    }
    ...
    public function upload($file)
    {
        ...
        $new_file_path = $this->setName($new_file_name)->path('public');
